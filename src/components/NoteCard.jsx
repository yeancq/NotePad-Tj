  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 flex-wrap">
        {note.verseCount > 0 && (
          <span className="inline-flex items-center gap-1 text-[11px] px-2 py-0.5 rounded-full bg-gilt/15 text-gilt dark:text-gilt-soft">
            📖 {note.verseCount} {note.verseCount === 1 ? 'versículo' : 'versículos'}
          </span>
        )}
        {note.tags.map((tag) => (
          <span
