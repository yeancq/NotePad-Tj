...
export default function App() {
  ...
  useEffect(() => {
    const checkVersion = async () => {
      try {
        ...
        // Si falla, no bloqueamos la app, solo mostramos la versión por defecto.
      } finally {
        // 🔥 **Esto es crucial**: asegura que la app siempre salga del estado de carga
  ...
  // ============================================================
  // Aquí se muestra el Splash mientras se verifica la versión o se muestra el Splash normal.
  if (isCheckingVersion || showSplash) {
    return <SplashScreen onFinish={() => setShowSplash(false)} />;
  }

  // ============================================================
  // 🖥️ Renderizado de pantallas
  // ============================================================
  if (showSettings) {
    return (
      <Settings
